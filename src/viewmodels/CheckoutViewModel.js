...
export function getValidationSchema() {
  return yup.object({
    ...
    celular: yup.string().required("Celular é obrigatório").matches(CELULAR_REGEX, "Celular inválido"),
    email: yup.string()
...
export const fields = [
  ...
  { name: "cpf", label: "CPF", attrs: { id: "cpf", placeholder: "000.000.000-00", required: true }, mask: "###.###.###-##" },
  { name: "celular", label: "Celular", attrs: { id: "celular", placeholder: "(00) 00000-0000", required: true }, mask: "(##) #####-####" },
  { name: "email", label: "Email", attrs: { id: "email", type: "email", required: true, placeholder: "exemplo@dominio.com" } },
  { name: "cep", label: "CEP", attrs: { id: "cep", placeholder: "00000-000", required: true }, mask: "#####-###" },
  ...
  { name: "estado", label: "Estado", attrs: { id: "estado", type: "text", maxlength: 2, required: true } },
];
